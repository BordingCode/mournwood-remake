...
export const CARDS = {
  ...
  snare: { id: 'snare', name: "Trapper's Snare", cost: 1, type: 'skill', target: 'enemy',
           text: 'Apply 2 Vulnerable, 2 Weak and 2 Expose.', effects: [{ k: 'status', status: 'vulnerable', amount: 2 }, { k: 'status', status: 'weak', amount: 2 }, { k: 'status', status: 'expose', amount: 2 }],
           up: { text: 'Apply 3 Vulnerable, 3 Weak and 3 Expose.', effects: [{ k: 'status', status: 'vulnerable', amount: 3 }, { k: 'status', status: 'weak', amount: 3 }, { k: 'status', status: 'expose', amount: 3 }] } },
  ...
  pierce: { id: 'pierce', name: 'Pierce', cost: 1, type: 'attack', target: 'enemy',
           text: 'Deal 5. Apply 2 Vulnerable and 2 Expose.', effects: [{ k: 'damage', amount: 5 }, { k: 'status', status: 'vulnerable', amount: 2 }, { k: 'status', status: 'expose', amount: 2 }],
           up: { text: 'Deal 7. Apply 3 Vulnerable and 3 Expose.', effects: [{ k: 'damage', amount: 7 }, { k: 'status', status: 'vulnerable', amount: 3 }, { k: 'status', status: 'expose', amount: 3 }] } },
  ...
  scrapblast: { id: 'scrapblast', name: 'Scrapblast', cost: 1, type: 'attack', target: 'enemy', tag: 'blunt',
           text: 'Deal 4, +3 per contraption you have. Apply 2 Expose.', effects: [{ k: 'damage', amount: { base: 4, perContraption: 3 } }, { k: 'status', status: 'expose', amount: 2 }],
           up: { text: 'Deal 6, +4 per contraption. Apply 3 Expose.', effects: [{ k: 'damage', amount: { base: 6, perContraption: 4 } }, { k: 'status', status: 'expose', amount: 3 }] } },
  ...
  mistveil: { id: 'mistveil', name: 'Mist Veil', cost: 1, type: 'skill', target: 'all',
           text: 'Apply 2 Weak and 2 Expose to ALL foes.', effects: [{ k: 'status', status: 'weak', amount: 2 }, { k: 'status', status: 'expose', amount: 2 }],
           up: { text: 'Apply 3 Weak and 3 Expose to ALL foes.', effects: [{ k: 'status', status: 'weak', amount: 3 }, { k: 'status', status: 'expose', amount: 3 }] } },
